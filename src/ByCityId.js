...
function ByCityId({cityID,setCityID}) {
    return (
            <Row className='mt-3'>
                <Col >
                    <Form>
                        <Form.Group controlId="exampleForm.SelectCustom">
                            <Form.Label>By City Id</Form.Label>
                            <Form.Control  type="select" value={cityID} onChange={(e)=>setCityID(e.target.value)} as="select" custom>
                                <option></option>
