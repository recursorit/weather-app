...
function Select({ loading, cityName, setCityName, cityID, setCityID, longitude, setLongitude, latitude, setLatitude, zipCode, setZipcode, searchWeather }) {
        ...
        <div className=''>
            ...
            <Card style={{ width: '100%' }} className='p-3 shadow mt-3'>
                ...
                <Row className='justify-content-center'>
                    <Col lg={2} xs={4}>
                        <Button className='mt-5 ' onClick={searchWeather} disabled={!cityName && !cityID && !(longitude && latitude) && !zipCode}>
                            {loading ? <Spinner
                                className="mr-2"
                                as="span"
                                animation="border"
